...
public class Withdrawal extends Transaction
{
   ...
   private void performWithdrawal() {
      ...
      if(!cashDispenser.AnyBillsAvaliable()){
         ...
         stateNum = 0;
         //new MessageFrame("ATM disable","<html>This ATM is temporary disabled.<br></br>Please use other ATM.</html>", 3);
         return;
      }
      ...
      if(!cashDispenser.canBillsHandleTheJob( amount )){
         ...
         stateNum = 1;
         //new MessageFrame("Not enough bills", "<html>Not enough bills in the ATM to handle your withdrawal request.<br></br> Please use other ATM.</html", 3);
         return;
      }
      ...
      if ( amount != CANCELED )
      {
         ...
         {   
            ...
            if ( cashDispenser.isSufficientCashAvailable( amount ) )
            {
               ...
               screen.displayMessageLine( 
                  ...
                  stateNum = 2;
                  //new MessageFrame("Take Card","<html>Withdrawal success.<br></br>Please take your card now.</html>", 3);
                  
                  //new MessageFrame("Take Cash","Please take your cash now.", 3);
            ...
            { // cash dispenser does not have enough cash
               screen.displayMessageLine( 
                  ...
                  stateNum = 3;
                  //new MessageFrame("Insufficient cash","<html>Insufficient cash available in the ATM.<br></br>Please choose a smaller amount.</html>", 3);
            }
         } // end if
         else // not enough money available in user's account
         {
            screen.displayMessageLine( 
               ...
               stateNum = 4;
               //new MessageFrame("Insufficient funds", "<html>Insufficient funds in your account.<br></br>Please choose a smaller amount.</html>", 3);
         } // end else
      } // end if
         ...
         switch (input) {
            ...
            default: // the user did not enter a value from 1-5
               if (input % 100 == 0) {
                  ...
                  screen.displayMessageLine(
                        "If you are willing to enter a custom value, make sure it is divisible by 100 and try again.");
               }
   ...
   private class WithdrawalFrame extends JFrame {
      ...
      private WithdrawalFrame() {
         ...
         // withdrawalPanel.setBorder(BorderFactory.createMatteBorder(10, 10, 10, 10,
         // Color.WHITE));
         withdrawalPanel.setPreferredSize(new Dimension(720, 350));
         withdrawalPanel.setBackground(Color.WHITE);

         // JPanel centerPanel = new JPanel(new
         // BoxLayout(withdrawalPanel,BoxLayout.Y_AXIS));
         ...
         withdrawJOption1.setBackground(new Color (65,125,128));
         withdrawJOption1.setBackground( Color.WHITE );
         withdrawJOption2 = new JButton("2 - $200");
         withdrawJOption2.setFont(FONTSTYLE);
         withdrawJOption2.setPreferredSize(buttonSize);
         withdrawJOption2.setBackground(new Color (65,125,128));
         withdrawJOption2.setBackground( Color.WHITE );
         withdrawJOption3 = new JButton("3 - $500");
         withdrawJOption3.setFont(FONTSTYLE);
         withdrawJOption3.setPreferredSize(buttonSize);
         withdrawJOption3.setBackground(new Color (65,125,128));
         withdrawJOption3.setBackground( Color.WHITE );
         withdrawJOption4 = new JButton("4 - $800");
         withdrawJOption4.setFont(FONTSTYLE);
         withdrawJOption4.setPreferredSize(buttonSize);
         withdrawJOption4.setBackground(new Color (65,125,128));
         withdrawJOption4.setBackground( Color.WHITE );
         withdrawJOption5 = new JButton("5 - $1000");
         withdrawJOption5.setFont(FONTSTYLE);
         withdrawJOption5.setPreferredSize(buttonSize);
         withdrawJOption5.setBackground(new Color (65,125,128));
         withdrawJOption5.setBackground( Color.WHITE );
         ...
         resetButton.setBackground(new Color (65,125,128));
         ...
         confirmButton.setBackground(new Color (65,125,128));
